...
namespace Match3.Tile
{
    public sealed class TileMatchChecker
    {
        ...
        private Dictionary<MatchType, Func<Match>> _matchCreators;
        ...
        {
            _coreTile = coreTile;
            _matchCreators = new Dictionary<MatchType, Func<Match>>()
            {
        ...
        public bool CheckMatch()
        {
            ...
            foreach (MatchType matchType in prioritizedMatches)
            {
                ...
                Match match = _matchCreators[matchType].Invoke();
        ...
        private Match CheckHorizontalMatch()
        {
            CheckDirection(Direction.Right);
            CheckDirection(Direction.Left);
        ...
        private Match CheckVerticalMatch()
        {
            CheckDirection(Direction.Top);
            CheckDirection(Direction.Bottom);
        ...
        private Match CheckSquareMatch()
        {
